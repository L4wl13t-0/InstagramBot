...
//Piyasada ilklerdendir
  ...
  await page.type('input[name="username"]', 'odettatrevisan28'); //'KULLANICI_ADINIZ '  KULLANICI_ADINIZ yazan kısma yani tırnakları silmeden tırnakların içerisine kullanıcı adınızı yazınız
  // console.log("Kullanıcı adı textbox'ına kullanıcı adınız yazılıyor");
  await page.type('input[name="password"]', 'wjOV6o2X400o'); // Aynı şekilde SIFRENIZ kısmına da o şekilde boşluk bırakmayın
 // console.log("Şifreniz textbox'ına şifreniz yazılıyor. Programda kesinlikle bir veri gönderimi gibi bir durum yok aksi durumda kodları inceleyin inceletiniz. Sorumluluk size aittir.");
  ...
  var photoNum=X; // 1.jpg adlı fotoğraftan başlatılır
